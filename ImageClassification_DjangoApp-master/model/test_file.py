...
PATH_TO_LABELS= r"/Users/neerajsingh/Desktop/django_project/model/hot_labelmap.pbtxt"
threshold=55
...
PATH_TO_SAVED_MODEL = r"/Users/neerajsingh/Desktop/django_project/model/saved_model"
...
#######function to run after pressing predict key 
...
def final_predict (image_path):
    ...
    for item in filtered_detection:
        ...
        if percentage >threshold:
            ...
            new_data = pd.DataFrame([{'image': image_path, 'release': "","hold":"Yes","True":true,"Process Duration":processed_time,"Image Resolution":(img.shape[1],img.shape[0]),"Number of Pixels":img.shape[1]*img.shape[0],"Rust Percentage":percentage}],
            ...
            new_data = pd.DataFrame([{'image': image_path, 'release': "Yes","hold":"","True":true,"Process Duration":processed_time,"Image Resolution":(img.shape[1],img.shape[0]),"Number of Pixels":img.shape[1]*img.shape[0],"Rust Percentage":percentage}],
                               columns =['image', 'release', 'hold',"True","Process Duration","Image Resolution","Number of Pixels","Rust Percentage"])
...
for image_path in IMAGE_PATHS:
  data_frame=data_frame.append(final_predict(image_path)[1], ignore_index = True)
  print(final_predict(image_path)[0])
